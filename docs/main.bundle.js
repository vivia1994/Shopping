...
var MyHeaderComponent = (function () {
    function MyHeaderComponent(pageInfoService, userInfo, shopCartItems, shopItems) {
    ...
    MyHeaderComponent.prototype.addToShopCart = function (shopItem) {
        ...
        for (var _b = 0, _c = this.shopCartItems.shopCartItems; _b < _c.length; _b++) {
            var item = _c[_b];
            totalPriceTemp += item.price;
        }
        this.shopItems.totalPrice = totalPriceTemp;
        for (var _d = 0, _e = this.shopCartItems.shopCartItems; _d < _e.length; _d++) {
            var item = _e[_d];
